...
{
	typedef std::pair<std::string, levels> data;
	std::list<data> pairList;
	int numLevel = -1;

	pairList.push_back(data("DEBUG", DEBUG));
	pairList.push_back(data("INFO", INFO));
	pairList.push_back(data("WARNING", WARNING));
	pairList.push_back(data("ERROR", ERROR));
